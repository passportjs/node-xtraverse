...
/**
 * Append an element, to the end of each element in the set of matched elements.
 *
 * This function returns the appended element to the child, unless text is
 * provided.  If you need to add another child, it is necessary to use `up()` to
 * go back to the parent in the tree.
 *
 * Examples:
 *
 *     el.c('bar');
 ...
 * @param {Object|String} [attrs] Attributes of XML element, or text.
 * @param {String} [text] Text content of XML element.
 * @return {Collection} The wrapped appended element.
 * @api public
 */
 ...
 *
 * @param {String} name Name of XML element.
 * @param {String} [ns] Namespace of XML element.
 * @param {Object} [attrs] Attributes of XML element.
